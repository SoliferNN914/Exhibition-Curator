...
// const ExhibitionGrid = ({ searchTerm, filters }) => {
//   const [artworks, setArtworks] = useState([]);
//   const [loading, setLoading] = useState(false);
//   const [error, setError] = useState(null);
//   const [selectedArtWork, setSelectedArtWork] = useState(null);
...
//         // Pass the filters to the searchArtworks function
//         const objectIDs = await searchArtworks(defaultSearch, filters);
//         if (objectIDs.length === 0) {
//           setArtworks([]);
//           setError('No artworks found for the search term.');
//           return;
...
//                 <Image src={artwork.primaryImageSmall} alt={artwork.title} />
//                 <Title>{artwork.title}</Title>
//                 <button onClick={(event) => saveToExhibition(artwork, event)}>
//                   Add to Exhibition
//                 </button>
//               </GridItem>
//             ))
